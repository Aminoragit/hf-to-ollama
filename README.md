...
- **📦 Safetensors 전체 저장소 변환 다운로드 (New!)**  
  저장소에 GGUF가 없거나 Safetensors를 선택할 경우, `hf-to-ollama`가 핵심 뼈대 파일 구조(`.safetensors`, `.json` 등)를 자동 스캔하여 일괄 다운로드 후 Ollama Native 엔진을 통해 완벽한 생성 및 변환을 마쳐줍니다!
  <br />
