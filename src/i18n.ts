...
const ko: MessageMap = {
  ...
  "success.already_downloaded": (params) => `이미 다운로드된 파일 존재 (다운로드 생략): ${params.path} (${params.size})`,
...
const en: MessageMap = {
  ...
  "success.already_downloaded": (params) => `File already downloaded (skipped): ${params.path} (${params.size})`,
