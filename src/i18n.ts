...
const ko: MessageMap = {
  ...
  "prompt.search_query": "검색할 모델 이름이나 키워드를 입력하세요 (예: Llama 3 8B):",
  "prompt.search_query.required": "검색어를 입력해야 합니다.",
  "prompt.search_result": "검색 결과에서 설치할 모델을 선택하세요:",
...
const en: MessageMap = {
  ...
  "prompt.search_query": "Enter a model name or keyword to search (e.g., Llama 3 8B):",
  "prompt.search_query.required": "You must enter a search query.",
  "prompt.search_result": "Select a model to install from the search results:",
